...
// ========================================================================
// "云来剑法·重制"附魔 - 剑专属（单级·宝箱限定）
//
// 获取方式：仅以附魔书形式在遗迹宝箱中出现（附魔台无法获得）
//
// 【效果】
//   1. 攻击命中时，90%概率挥出1道月牙形剑气（向前飞行、穿透敌人）
//      剑气伤害 = 本次攻击 × 0.5
//   2. 攻击速度 +3.5（手持时自动生效，切换武器自动移除）
//   3. 粒子效果：淡蓝色月牙
//
// 与"古·云来剑法·重制"互斥（同一把剑只能二选一）
//
// 兼容性：
...
public class YunLaiSwordmanshipEnchantment extends Enchantment {
    ...
    public YunLaiSwordmanshipEnchantment() {
        // Rarity.VERY_RARE：非常稀有，匹配宝箱获取定位
